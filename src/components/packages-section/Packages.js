        ...
        <div className='container-xxl px-xxl-0 px-lg-5 px-md-4 px-sm-3 py-md-4 py-3'>
          ...
          <div className="tags d-flex mt-3 justify-content-center">
            <ul className="d-flex flex-wrap">
              <li>
                <button className="btn" value='All' name='All' onClick={handleCLick('All')}>
                  All
                </button>
              </li>
              <li>
                <button className="btn" value='Student' name=' Student' onClick={handleCLick('student')}>
                  Student
                </button>
              </li>
              <li>
                <button className="btn"  value='Professional' name='Professional 'onClick={handleCLick('professional')}>
                  Professional
                </button>
              </li>
              <li>
                <button className="btn" value=' Entrepreneur' name='Entrepreneur' onClick={handleCLick('entrepreneur')}>
                  Entrepreneur
                </button>
              </li>
              <li>
                <button
                  className="nav-link btn" value='More Filters' name='More Filters'
