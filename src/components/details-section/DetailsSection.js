        ...
        <div className='row text-center'>
          <div className='col-md-3 col-6 mb-md-0 mb-4'>
            <div className='details-card'>
              <h1 className='mb-0'>
                <CountUp start={focus ? 0 : null} end={2000} duration={4}>
                  {({ countUpRef }) => (
                    <VisibilitySensor
                      onChange={(isVisible) => {
                        if (isVisible) {
          ...
          <div className='col-md-3 col-6 mb-md-0 mb-4'>
            <div className='details-card'>
              <h1 className='mb-0'>
                <CountUp start={focus ? 0 : null} end={20} duration={4}>
                  {({ countUpRef }) => (
                    <VisibilitySensor
                      onChange={(isVisible) => {
                        if (isVisible) {
          ...
          <div className='col-md-3 col-6'>
            <div className='details-card'>
              <h1 className='mb-0'>
                <CountUp start={focus ? 0 : null} end={100} duration={4}>
                  {({ countUpRef }) => (
                    <VisibilitySensor
                      onChange={(isVisible) => {
                        if (isVisible) {
          ...
          <div className='col-md-3 col-6'>
            <div className='details-card'>
              <h1 className='mb-0'>
                <CountUp start={focus ? 0 : null} end={10000} duration={4}>
                  {({ countUpRef }) => (
                    <VisibilitySensor
                      onChange={(isVisible) => {
                        if (isVisible) {
