...
const BeAMentor = () => {
  ...
  const [othergetToKnow, SetOtherGetToKnow] = useState('');
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(
      beMentor({
        ...
        firstPref: firstPref,
        OtherFirstPref:OtherFirstPref,
        secondPref: secondPref,
        OtherSecondPref:OtherSecondPref,
        thirdPref: thirdPref,
        OtherThirdPref:OtherThirdPref,
        designation: designation,
        about: about,
        getToKnow: getToKnow,
        othergetToKnow:othergetToKnow,
              ...
              {firstPref === 'Others' && (
                <div className='form-group mb-4'>
                  ...
                  <input
                    ...
                    className='form-control'
                    placeholder='Other Industry'
                    value={OtherFirstPref}
                    onChange={(e) => SetOtherFirstPref(e.target.value)}
                  />
                </div>
              )}
              <div className='form-group mb-4'>
              ...
              {secondPref === 'Others' && (
                <div className='form-group mb-4'>
                  ...
                  <input
                    ...
                    className='form-control'
                    placeholder='Other Industry'
                    value={OtherSecondPref}
                    onChange={(e) => SetOtherSecondPref(e.target.value)}
                  />
                </div>
              )}
              <div className='form-group mb-4'>
              ...
              {thirdPref === 'Others' && (
                <div className='form-group mb-4'>
                  ...
                  <input
                    ...
                    className='form-control'
                    placeholder='Other Industry'
                    value={OtherThirdPref}
                    onChange={(e) => SetOtherThirdPref(e.target.value)}
                  />
                </div>
              )}
              <div className='form-group mb-4'>
              ...
              {getToKnow === 'Others' && (
                <div className='form-group mb-4'>
                  ...
                  <input
                    ...
                    className='form-control'
                    placeholder='Other Industry'
                    value={othergetToKnow}
                    onChange={(e) => SetOtherGetToKnow(e.target.value)}
                  />
                </div>
              )}
